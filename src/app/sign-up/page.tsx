        ...
        <div className="mx-auto grid w-full max-w-[1180px] gap-6 lg:grid-cols-[1.02fr_0.98fr] lg:items-start">
          <section className="rounded-[28px] border border-white/12 bg-zinc-900/72 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.42)] md:p-8">
            ...
            <p className="mt-5 max-w-[60ch] text-base leading-8 text-zinc-300">
              Start with account identity now, then scale into collaborative production workflows.
            </p>
            <div className="mt-6 grid gap-3 text-sm leading-7 text-zinc-300">
              <div className="rounded-2xl border border-white/10 bg-zinc-800/45 px-4 py-3">Account data persisted in SQLite</div>
              <div className="rounded-2xl border border-white/10 bg-zinc-800/45 px-4 py-3">No disruption to existing creation flow</div>
              <div className="rounded-2xl border border-white/10 bg-zinc-800/45 px-4 py-3">Ready for future project and permission layers</div>
            </div>
