      ...
      <section className="relative z-10 px-4 pb-18 pt-12 md:px-8 md:pt-16">
        <div className="mx-auto w-full max-w-[1180px]">
          ...
          >
            ...
            <h1 className="font-heading text-balance text-[clamp(2.3rem,5vw,4.6rem)] leading-[0.95] font-semibold tracking-[-0.045em] text-zinc-50">
      ...
      <section className="relative z-10 px-4 pb-14 md:px-8 md:pb-18">
        <div className="mx-auto grid w-full max-w-[1180px] gap-6">
          <div className="grid gap-2 text-center">
            <h2 className="font-heading text-2xl font-semibold tracking-[-0.035em] text-zinc-50 md:text-3xl">Turn creative intent into production-ready scenes</h2>
              ...
              >
                <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                  <div className="inline-flex items-center gap-2">
                    ...
                    <h3 className="font-heading text-lg font-semibold tracking-[-0.02em] text-zinc-100 md:text-xl">{item.title}</h3>
                  </div>
          ...
          <section className="mt-4 grid gap-3 rounded-[24px] border border-white/12 bg-zinc-900/72 p-5 shadow-[0_10px_36px_rgba(0,0,0,0.34)] md:p-6">
            <div className="inline-flex items-center gap-2 text-zinc-200">
              ...
              <h3 className="font-heading text-lg font-semibold tracking-[-0.02em]">Frequently asked questions</h3>
            </div>
